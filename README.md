...
## О проектах:
- это проекты с курса Профессия аналитик данных. Яндекс.Практикум;
- нумерация проектов (project1, project2...) соответствует хронологическому порядку прохождения курса;
- примерные времязатраты на выполнение 9 проектов (это 2/3 курса, впереди еще 3 проекта) около 180 часов. Затраты на изучение теории (тренажер ЯП, теоретические блоки и доп. материалы): еще около 60 часов.
